...
$(document).ready(function () {
  ...
  if ($('.sg-checkboxSwitcher__button')) {
    $('.sg-checkboxSwitcher__button').on('click', function (event) {
      $(event.target).parent().toggleClass('sg-js-checkboxSwitcher--activated');
    });
  }
});
...
var tooltipElement = document.querySelector('.sg-tooltip');
if (tooltipElement) {
...
if ($('.sg-single-item').length > 0) {
  $('.sg-single-item').slick(settings);
}
if ($('.sg-steps__header')) {
  $('.sg-steps__header').next().toggle();

  $('.sg-steps__header').on('click', function(event) { 
    $(event.target).parent('.sg-steps__header').next().slideToggle();
    $(event.target).parent('.sg-steps__header').toggleClass('sg-animated');
  })
}

if ($('.sg-steps__put-header')) {
  $('.sg-steps__put-header').on('click', function(event) { 
    $(event.target).parent('.sg-steps__put-header').next().slideToggle();
    $(event.target).parent('.sg-steps__put-header').toggleClass('sg-animated');
  })
}
if ($('.sg-menu-switch__header')) {
    $('.sg-menu-switch__header').on('click', function(event) { 
        if ($(event.target).hasClass('sg-menu-switch__img')) {
            $(event.target).parent().parent('.sg-menu-switch__header').next().slideToggle();
            return $(event.target).parent().parent('.sg-menu-switch__header').toggleClass('sg-animated');
        }
        $(event.target).parent().parent('.sg-menu-switch__header').next().slideToggle();
        $(event.target).parent().parent('.sg-menu-switch__header').toggleClass('sg-animated');
    })
}
});